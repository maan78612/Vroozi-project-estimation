...
@Component({
  ...
  imports: [ButtonComponent, RouterLink, InitialsPipe],
...
export class UsersListComponent {
  ...
  private readonly employees = this.authService.getAssignableUsers();
  ...
  viewProjects(user: UserInterface): void {
    this.router.navigate(['/admin/projects'], {
      queryParams: { q: user.fullName || user.username },
    });
  }
